...
const FLOAT_NODE = new Node({ id: 'float', type: 'float', label: 'Float input', outputs: [{ "name": "Value", "type": "float", "default": 0 }] })
const STRING_NODE = new Node({ id: 'string', type: 'string', label: 'String input', outputs: [{ "name": "Value", "type": "string", "default": "" }] })
const BOOLEAN_NODE = new Node({ id: 'boolean', type: 'boolean', label: 'Boolean input', outputs: [{ "name": "Value", "type": "boolean", "default": false }] })
